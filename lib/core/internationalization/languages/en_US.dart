Map<String, String> get enUSKeys => <String, String>{
      ...
      'REGISTER__password_hintText': 'Enter your password',
      'REGISTER__confirm_password_hintText': 'Confirm your password',
      'REGISTER__already_account': 'You already have an account ?',
    };
