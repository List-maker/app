...
class IcList {
  ...
  static const IconData check_no_checked = IconData(0xe802, fontFamily: _fontFamily);
  static const IconData check_checked = IconData(0xe803, fontFamily: _fontFamily);
